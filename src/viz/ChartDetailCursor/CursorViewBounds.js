...
export default class CursorViewBounds extends React.PureComponent {
	...
	render() {
		...
		return (
			<div className="popover-bounds-container" ref={this.boundsContainerRef}
				 style={_.pick(this.props, 'width', 'height')}>
				{
				...
				<ChartDetailCursor {..._.pick(this.props, 'windowWidth', 'windowHeight', 'href', 'schemas')}
								   ref={this.cursorRef}/>
			</div>
		);
	}
