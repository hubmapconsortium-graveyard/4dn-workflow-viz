			...
			if (filterID === 'svg-filter-highlight') {
				filterComponents.push(
					<filter id="svg-filter-highlight" key="svg-filter-highlight">
						...
						<feImage xmlnsXlink="http://www.w3.org/1999/xlink"
						...
						<feComposite operator="in" in="STRIPED-FILL_20" in2="SourceAlpha"
									 result="STRIPED-FILL_30"></feComposite>
						<feComposite operator="in" in="COLOR-black" in2="STRIPED-FILL_30"
									 result="STRIPED-FILL_40"></feComposite>
