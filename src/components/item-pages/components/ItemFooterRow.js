...
export class ItemFooterRow extends React.Component {
	...
	alternateAccessions() {
		...
		var alternateAccessions = this.props.context.alternate_accessions.length > 0 ? this.props.context.alternate_accessions : [
			<em>None</em>];
		return (
			<div>
	...
	externalReferences(schemas) {
		...
		var externalRefs = this.props.context.external_references.length > 0 ? this.props.context.external_references : [
			<em>None</em>];
		return (
			<div>
