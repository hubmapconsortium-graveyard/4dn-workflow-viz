			...
			<div
				...
				<ResultDetail {...{
					...
					selectedFiles
							  ...
							  open={!!(detailOpen)} toggleDetailOpen={this.toggleDetailOpen}
...
class ShadowBorderLayer extends React.Component {
	...
	edgeScrollButtonLeft(leftEdgeContentWidth) {
		...
		return (
			<div className={className} onMouseDown={this.handleLeftScrollButtonMouseDown}
				 onMouseUp={this.handleScrollButtonUp} onMouseOut={this.handleScrollButtonUp}>
	...
	edgeScrollButtonRight(rightEdgeContentWidth) {
		...
		return (
			<div className={className} onMouseDown={this.handleRightScrollButtonMouseDown}
				 onMouseUp={this.handleScrollButtonUp} onMouseOut={this.handleScrollButtonUp}>
						...
						<div className="inner-container" ref={this.innerContainerRef}>
							<div className="scrollable-container" style={{minWidth: fullRowWidth + 6}}>
								<Sticky windowWidth={windowWidth} topOffset={this.stickyHeaderTopOffset()}
										children={this.renderHeadersRow}/>
								<LoadMoreAsYouScroll
...
export class SearchResultTable extends React.PureComponent {
	...
	static defaultProps = {
		...
		'renderDetailPane': function (result, rowNumber, width) {
			return <DefaultDetailPane {...{result, rowNumber, width}} />;
		},
