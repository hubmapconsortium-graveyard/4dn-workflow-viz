...
import url from 'url';
import {expFxn, Filters, ajax, layout, isServerSide, navigate} from '../../util';
		...
		return (
			<div className={"facet-charts show-" + show} key="facet-charts">
				<ChartDataController.Provider id="barplot1">
					<BarPlot.UIControlsWrapper legend chartHeight={height} {...{href, windowWidth, cursorDetailActions}}
											   expSetFilters={Filters.currentExpSetFilters()}>
