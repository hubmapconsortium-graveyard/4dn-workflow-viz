...
export class ExperimentSetDetailPane extends React.PureComponent {
	 ...
	 */
	static allFileIDs(expSet) {
		return _.pluck(expFxn.allFilesFromExperimentSet(expSet), 'uuid');
	}
											  ...
											  columnHeaders={[
												  {
													  ...
													  title: 'File Type',
													  render: renderFileTypeSummaryColumn
												  },
												  {
													  columnClass: 'file-detail',
													  title: 'File Size',
		...
		return (
			<div className="processed-files-table-section">
				<h4 className="pane-section-title" onClick={this.toggleProcessedFilesOpen}>
					...
					<i className="icon icon-fw icon-microchip"/> <span
					className="text-400">{processedFiles.length}</span> Processed Files
				</h4>
	...
	render() {
		...
		return (
			<div className="experiment-set-info-wrapper">
					...
					<div className="row">
						...
						<div className="col-md-6 addinfo-properties-section">
							...
							<div className="row mb-05 clearfix">
								...
								<div className="col-xs-8 col-sm-9 expset-addinfo-val">
									{object.itemUtil.generateLink(result.produced_in_pub) ||
				...
				<div style={{overflowX: 'auto', width: containerWidth ? (containerWidth - usePadWidth) : null}}
					 className="files-tables-container">
