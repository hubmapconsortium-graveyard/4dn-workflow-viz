...
class LabsSection extends React.PureComponent {
	...
	contributingLabRenderFxn(lab, idx, all) {
		...
		return (
			<div
				className={"lab" + (all.length === 1 && (!contactPersons || contactPersons.length === 0) ? ' mt-1' : '')}
				key={atId || idx}>
				<h5>
	...
	render() {
		...
		return (
			<div className={className}>
				...
				{contributingLabs ?
					<WrappedCollapsibleList wrapperElement="div" items={contributingLabs}
											singularTitle="Contributing Lab"
