...
export default class ErrorPage extends React.Component {
	render() {
		...
		if (this.props.status === 'invalid_login') {
			...
			errorMessage = <h3>The page you've requested does not exist or you have found an error. {homelink} to the
				homepage.</h3>;
		}
		...
		return (
			<div className="error-page text-left container" id="content">
				...
				<div className="content fourDN-content">
					<p>
						If you have an account, please try logging in or return to the <a
						href="/">homepage</a>. <br/> For instructions on how to set up an account, please visit the help
						page for <a href="/help/account-creation">Creating an Account</a>.
					</p>
				</div>
			</div>
		);
