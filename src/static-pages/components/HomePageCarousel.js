...
export class HomePageCarouselSlide extends React.PureComponent {
	...
	render() {
		...
		if (link) {
			...
			return (
				<a className="homepage-carousel-slide is-link" href={link} target={isExternalLink ? '_blank' : null}
...
export class HomePageCarousel extends React.PureComponent {
	...
	render() {
		...
		return (
			<div className="homepage-carousel-wrapper" ref={HomePageCarousel.refFunc} style={{'opacity': 0}}
				 key="carousel">
