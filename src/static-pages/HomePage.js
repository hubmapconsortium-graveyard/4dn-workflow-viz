			...
			<div className="homepage-wrapper">
				...
				<div className="container home-content-area" id="content">
					...
					<div className="mt-4">
						...
						<Announcements session={this.props.session}
									   announcements={this.props.context.announcements || null}/>
					</div>
				</div>
	...
	externalLinks() {
		...
		return (
			<div className="homepage-links-column external-links">
				...
				<div className="links-wrapper clearfix">
					<div className="link-block">
						<a href="http://www.4dnucleome.org/" target="_blank" rel="noopener noreferrer"
						   className="external-link">
							<span>Main Portal</span>
						</a>
					</div>
					<div className="link-block">
						<a href="http://dcic.4dnucleome.org/" target="_blank" rel="noopener noreferrer"
						   className="external-link">
							<span>4DN DCIC</span>
						</a>
					</div>
					<div className="link-block">
						<a href="https://commonfund.nih.gov/4Dnucleome/index" target="_blank" rel="noopener noreferrer"
						   className="external-link">
					...
					<div className="link-block">
						<a href="https://commonfund.nih.gov/4Dnucleome/FundedResearch" target="_blank"
						   rel="noopener noreferrer" className="external-link">
